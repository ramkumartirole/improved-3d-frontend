...
export const focusOnModel = (
  ...
  const directionVector = new THREE.Vector3(
    ...
    direction.y,
    direction.z
  ).normalize(); // get the direction vector of the object
  ...
  const animate = () => {
    ...
    camera.lookAt(center); // look at the center of the object
    controls.target.copy(center); // copy the center of the object to the target
